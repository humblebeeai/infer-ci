...
if __name__ == "__main__":
    print("Binary Classification Confidence Interval Test")
    print("=" * 80)
    
    try:
        # Run main test (replicates example_binary.ipynb)
        test_passed = test_binary_classification_ci()
        
        print(f"\n" + "=" * 80)
        if test_passed:
            print("🎉 BINARY CLASSIFICATION CI TEST COMPLETED SUCCESSFULLY!")
        else:
            print("⚠️  BINARY CLASSIFICATION CI TEST COMPLETED WITH SOME ISSUES")
        print("=" * 80)
